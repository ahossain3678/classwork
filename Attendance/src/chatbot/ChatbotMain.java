...
public class ChatbotMain {
	...
	/* returns index of keyword after StartPsn that is isolated
	 *  and has no negations or -1 otherwise
	 */
	public static int findKeyword(String searchString, String keyword, int startPsn) {
		...
		while(psn >= 0) {
			if(keywordIsIsolated(psn, keyword, searchString) && noNegations(searchString, psn)) {
				...
				psn = searchString.indexOf(keyword, psn+1); //returns index of the next keyword
			}
		}
		return -1;
	}
